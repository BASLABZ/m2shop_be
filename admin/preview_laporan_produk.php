       <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    <div class="title-action">
                        <a href="cetak_laporan_produk.php" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Laporan Produk </a>
                    </div>
                </div>
            </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="wrapper wrapper-content animated fadeInRight">
                    <div class="ibox-content p-xl">
                    	...
                    	<center><h2>Laporan Keseluruhan Data Produk</h2></center>
